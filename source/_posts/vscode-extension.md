...
* [HTML Snippets](https://marketplace.visualstudio.com/items?itemName=abusaidm.html-snippets)
  ...
  + 各种 HTML 标签片段, 如果你 [Emmet](https://henrytsz.github.io/2018/09/05/vscode-complete-config/#toc-heading-21) 玩的熟, 完全可以忽略这个
...
* [Vim](https://marketplace.visualstudio.com/items?itemName=vscodevim.vim)
  ...
  + [每日一 Vim 笔记](https://henrytsz.github.io/2018/05/08/the-notes-of-a-daily-vim)
...
* [Open in Finder](https://marketplace.visualstudio.com/items?itemName=fabiospampinato.vscode-open-in-finder)
  ...
  + [在 Finder 中使用 VSCode 打开文件或文件夹 | Henry](https://henrytsz.github.io/2019/01/11/open-with-vs-code-in-finder/)
...
* [Open in Terminal](https://marketplace.visualstudio.com/items?itemName=fabiospampinato.vscode-open-in-terminal#overview)
  ...
  + [在 Terminal 中使用 VSCode 打开文件或文件夹 | Henry](https://henrytsz.github.io/2019/04/02/open-with-vs-code-in-terminal/)
