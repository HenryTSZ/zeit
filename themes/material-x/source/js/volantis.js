...
!(function(e, t) {
  ...
  return (function(e) {
          ...
          function n(e) {
            ...
            function r() {
              ...
              var r = Math.round(parseFloat(e.style.height)),
                ...
                o =
                  'content-box' === i.boxSizing ? Math.round(parseFloat(i.height)) : e.offsetHeight
              if (
                (o < r
                  ? 'hidden' === i.overflowY &&
                    (t('scroll'),
        ...
        (r.prototype._init = function() {
          ...
          try {
            ...
            e.nodata = {
              show: function(t) {
                return (
                  (U.innerHTML = t || e.locale.tips.sofa), u.attr(U, 'style', 'display:block;'), e
                )
              },
              hide: function() {
        ...
        (r.prototype.ErrorHandler = function(e) {
          ...
          if ((t.el && t.loading.hide().nodata.hide(), '[object Error]' === {}.toString.call(e))) {
            ...
            101 == n
              ? t.nodata.show()
              : (t.el &&
                  t.nodata.show('<pre style="text-align:left;">Code ' + n + ': ' + r + '</pre>')) ||
                console
          } else
            (t.el &&
          ...
          var M = function(e, n, r) {
              ...
              s &&
                (l =
                  ...
                  '</span>'),
                '*' === y &&
                  (l = '<a href="' + e.get('url') + '" class="vsys">' + e.get('url') + '</a>')
              var p,
                f = e.get('link') || ''
              ;(p = f
          ...
          var j = u.find(t.el, '.vsubmit'),
            B = function(e) {
              return u.attr(j, 'disabled')
                ...
                : '' == v.mail
                ? void _.mail.focus()
                : ((v.nick = v.nick || 'Anonymous'), void (t.notify || t.verify ? I(U) : U()))
            },
            P = function() {
              var e = new AV.ACL()
            ...
            I = function e(n) {
              ...
              t.alert.show({
                ...
                cb: function() {
                  ...
                  new Function('return ' + s.replace(/x/g, '*'))() === r
                    ? n && n()
                    : t.alert.show({
                        type: 1,
    ...
    function(e, t) {
      function aru(index) {
        return (
          "<img id='emoji' src='https://cdn.jsdelivr.net/gh/xaoxuu/volantis@1.0/img/aru/" +
          index +
          ".png'>"
        )
      }
      function tieba(str) {
        return (
          "<img id='emoji' src='https://cdn.jsdelivr.net/gh/xaoxuu/volantis@1.0/img/tieba/" +
          str +
          ".png'>"
        )
      }
      function qq(str) {
        return (
          "<img id='emoji' src='https://cdn.jsdelivr.net/gh/xaoxuu/volantis@1.0/img/qq/" +
          str +
          ".gif'>"
        )
      }
